...
public class TankPacket extends GUPacketBase {
    ...
    protected void execute(EntityPlayer player, Side side) throws ProtocolException {
        ...
        if (side == Side.CLIENT) {
            ...
            if (player.worldObj.getTileEntity(x, y, z) != null && player.worldObj.getTileEntity(x, y, z) instanceof TileBase) {
                
                TileBase tank = (TileBase) player.worldObj.getTileEntity(x, y, z);
