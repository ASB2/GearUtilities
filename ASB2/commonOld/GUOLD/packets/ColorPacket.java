...
public class ColorPacket extends GUPacketBase {
    ...
    protected void execute(EntityPlayer player, Side side) throws ProtocolException {
        ...
        if (itWorked && side == Side.CLIENT) {
            ...
            if (player.worldObj.getTileEntity(x, y, z) != null && player.worldObj.getTileEntity(x, y, z) instanceof IColorable) {

                IColorable colorable = (IColorable)player.worldObj.getTileEntity(x, y, z);
