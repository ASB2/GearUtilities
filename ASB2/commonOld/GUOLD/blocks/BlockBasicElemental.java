...
public class BlockBasicElemental extends BlockBase {
    ...
    IIcon[] fireTextures = new IIcon[6];
    IIcon[] waterTextures = new IIcon[6];
    IIcon[] earthTextures = new IIcon[6];
    IIcon[] airTextures = new IIcon[6];
    IIcon[] voidTextures = new IIcon[6];
    IIcon[] metallicTextures = new IIcon[6];
    IIcon[] bloodTextures = new IIcon[6];
    
    public BlockBasicElemental(Material material) {
        super(material);
    ...
    @Override
    public void onNeighborBlockChange(World world, int x, int y, int z, Block neightborId) {
        ...
        switch (world.getBlockMetadata(x, y, z)) {
            ...
            case FIRE_CUBE: {
                ...
                if (world.isBlockIndirectlyGettingPowered(x, y, z)) {
                    ...
                    UtilBlock.placeBlockInAir(world, x, y + 1, z, Blocks.fire, 0);
                }
                else {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        switch (world.getBlockMetadata(x, y, z)) {
            ...
            case EARTH_CUBE: {
                ...
                Block block = world.getBlock(x, y + change, z);
    ...
    public boolean isFireSource(World world, int x, int y, int z, ForgeDirection side) {
        ...
        return world.getBlockMetadata(x, y, z) == FIRE_CUBE && side == ForgeDirection.UP;
    }
