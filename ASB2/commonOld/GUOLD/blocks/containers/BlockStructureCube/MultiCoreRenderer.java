package GUOLD.blocks.containers.BlockStructureCube;
...
public class MultiCoreRenderer extends TileEntitySpecialRenderer implements IItemRenderer {

    public static MultiCoreRenderer instance = new MultiCoreRenderer();
