...
public abstract class TileBase extends TileEntity implements IVanillaColorable, IWaitTrigger, IWrenchable {
    ...
    public TileBase() {
        ...
        if (color == null) color = VanillaColor.NONE;
    ...
    public Packet createCustomDescriptionPacket() {
    ...
    public Packet getDescriptionPacket() {
        ...
        return createCustomDescriptionPacket();
    }
    ...
    //
    // Packet packet = this.createCustomDescriptionPacket();
    ...
    public void readFromNBT(NBTTagCompound tag) {
        ...
        if (fluidTank != null) fluidTank.readFromNBT(tag.getCompoundTag("fluidTank"));
        
        if (color == VanillaColor.NONE || color == null) color = VanillaColor.values()[tag.getInteger("color")];
        
        if (this.powerProvider != null) this.powerProvider.readFromNBT(tag);
        
        if (tileInventory != null) tileInventory.load(tag);
    ...
    public void writeToNBT(NBTTagCompound tag) {
        ...
        if (fluidTank != null) tag.setTag("fluidTank", fluidTank.writeToNBT(new NBTTagCompound()));
        
        if (this.getColorEnum() != VanillaColor.NONE) tag.setInteger("color", this.getColorEnum().ordinal());
        
        if (this.powerProvider != null) this.powerProvider.writeToNBT(tag);
        
        if (tileInventory != null) tileInventory.save(tag);
