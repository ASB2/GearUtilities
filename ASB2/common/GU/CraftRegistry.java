...
public class CraftRegistry {
    ...
    public static void init() {
        ...
        GameRegistry.addRecipe(new ItemStack(Item.bucketLava), new Object[] {
                "FFF", "FSF", "FBF", 'F', ItemRegistry.ItemFireCrystalShard,
                'S', Block.stone, 'B', Item.bucketEmpty });

        GameRegistry.addRecipe(new ItemStack(BlockRegistry.BlockGarnetBlock),
                new Object[] { "DDD", "DDD", "DDD", 'D',
                        ItemRegistry.ItemGarnet });

        GameRegistry.addRecipe(new ItemStack(BlockRegistry.BlockSpeedyRoad, 8),
                new Object[] { "MMM", "QIQ", "QQQ",
                        // 'M', BlockRegistry.BlockMagiciansBuildingBlocks,
                        'M', Block.stone, 'Q', Block.blockNetherQuartz, 'I',
                        Item.ingotIron });

        GameRegistry.addRecipe(
                new ItemStack(ItemRegistry.ItemPhantomPlacer, 1), new Object[] {
                        "QIQ", " S ", " S ", 'S', Item.stick, 'Q',
                        Block.blockNetherQuartz, 'I', Item.ingotIron });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(Item.seeds),
                new ItemStack(Item.wheat));
        GameRegistry.addShapelessRecipe(new ItemStack(
                ItemRegistry.ItemTeleporter), new ItemStack(
                ItemRegistry.ItemTeleporter));
        GameRegistry.addShapelessRecipe(new ItemStack(ItemRegistry.ItemLinker),
                new ItemStack(ItemRegistry.ItemLinker));
        GameRegistry.addShapelessRecipe(new ItemStack(ItemRegistry.ItemGarnet,
                9), new ItemStack(BlockRegistry.BlockGarnetBlock));
    }
