...
public class ChestConstructionManager extends CubeConstructionManager {
    
    public ChestConstructionManager(World world, MultiBlockBase multiBlock, Vector3i positiveMostPoint, Vector3i size) {
