...
public class GrinderConstructionManager extends CubeConstructionManager {
    
    public GrinderConstructionManager(World world, MultiBlockBase multiBlock, Vector3i positiveMostPoint, Vector3i size) {
