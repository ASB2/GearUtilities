...
public abstract class MultiBlockBase implements IMultiBlock, IAbstractUpdateable {
    ...
    public abstract boolean placeAirBlock(Vector3i position);
    
    public abstract boolean placeEdgeBlock(Vector3i position);
    
    public abstract boolean placeCornerBlock(Vector3i position);
    
    public abstract boolean checkBlock(Vector3i position);
    
    public abstract void deconstructBlock(Vector3i position);
