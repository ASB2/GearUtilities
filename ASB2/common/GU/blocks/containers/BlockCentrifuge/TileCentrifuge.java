...
public class TileCentrifuge extends TileFluidBase {
    ...
    public void updateEntity() {
        ...
        if (fluidTank.drain(2, false) != null && outputTank.fill(new FluidStack(GU.FluidRegistry.LifeEssenceLiquid, 1), false) > 0) {
            
            fluidTank.drain(2, true);
            outputTank.fill(new FluidStack(GU.FluidRegistry.LifeEssenceLiquid, 1), true);
        }
    ...
    public int fill(ForgeDirection from, FluidStack resource, boolean doFill) {
        ...
        return GU.FluidRegistry.LifeEssenceGas == resource.getFluid() ? super.fill(from, resource, doFill) : 0;
    }
    
    @Override
    public boolean canFill(ForgeDirection from, Fluid fluid) {
        
        return GU.FluidRegistry.LifeEssenceGas == fluid ? super.canFill(from, fluid) : false;
    }
    ...
    public void writeToNBT(NBTTagCompound tag) {
        ...
        tag.setCompoundTag("outputTank", outputTank.writeToNBT(new NBTTagCompound()));
    }
}
