...
public class PhotonicConverterRenderer extends TileEntitySpecialRenderer implements IItemRenderer {
    
    public static PhotonicConverterRenderer instance = new PhotonicConverterRenderer();
    VariableIterator var = new VariableIterator(.0003, -.1, .1);
    
    public PhotonicConverterRenderer() {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        ((TilePhotonicConverter) tileentity).fuelType.bindTextureBase();
        Color4i colorBase = ((TilePhotonicConverter) tileentity).fuelType.getBaseColor();
        ...
        ((TilePhotonicConverter) tileentity).fuelType.bindTextureCenter();
        Color4i colorCenter = ((TilePhotonicConverter) tileentity).fuelType.getCenterColor();
