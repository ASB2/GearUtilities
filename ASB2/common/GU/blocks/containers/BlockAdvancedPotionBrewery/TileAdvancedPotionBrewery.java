...
public class TileAdvancedPotionBrewery extends TileBase implements IInventory, IFluidHandler, IPowerHandler {
    ...
    private void craftPotion() {
        ...
        if (hasRequired()) {
            ...
            if (UtilInventory.addItemStackToSlot(this, potion, 7, false)) {
                ...
                if (UtilFluid.removeFluidFromTank(this, ForgeDirection.UNKNOWN, new FluidStack(FluidRegistry.WATER, 1000), false) && this.getPowerProvider().usePower(100 * this.getIngredients().size() + getCombinedPower(), ForgeDirection.UNKNOWN, false)) {
                    ...
                    this.getPowerProvider().usePower(100 * this.getIngredients().size() + getCombinedPower(), ForgeDirection.UNKNOWN, true);
    ...
    public boolean hasRequired() {
        ...
        return (this.fluidTank.getFluidAmount() >= 1000) && (this.getPowerProvider().usePower(100 * this.getIngredients().size() + getCombinedPower(), ForgeDirection.UNKNOWN, false));
    }
