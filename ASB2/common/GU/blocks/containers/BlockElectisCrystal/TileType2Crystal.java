...
public class TileType2Crystal extends TileBase implements IColorableBlock, ICrystalPowerHandler, ICrystalNetworkPart {
    ...
    public TileType2Crystal getThis() {
    ...
    private class CrystalWrapper {
        ...
        public void setHandler(WeakReference<ICrystalPowerHandler> handler) {
