...
public class TeleportAlterRenderer extends TileEntitySpecialRenderer implements IItemRenderer {
    
    public static TeleportAlterRenderer instance = new TeleportAlterRenderer();
    
    public TeleportAlterRenderer() {
    }
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        
        {
            ...
            if (((TileTeleportAlter) tileentity).coordsSet)
