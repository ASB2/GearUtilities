...
public class BlockTeleportAlter extends BlockContainerBase {
    
    public BlockTeleportAlter(Material material) {
        super(material);
        this.registerTile(TileTeleportAlter.class);
    }
    ...
    public void postInitRender() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileTeleportAlter.class, TeleportAlterRenderer.instance);
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(this), TeleportAlterRenderer.instance);
    }
    
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
        
        TileTeleportAlter teleporter = (TileTeleportAlter) world.getTileEntity(x, y, z);
    ...
    public String getBlockDisplayName(ItemStack stack) {
        ...
        return "Teleport Alter";
    }
    
    @Override
    public TileEntity createNewTileEntity(World var1, int var2) {
        
        return new TileTeleportAlter();
    }
}
