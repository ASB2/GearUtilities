...
public class ItemElectisPolyhedronRenderer extends TileEntitySpecialRenderer implements IItemRenderer {
    
    public static ItemElectisPolyhedronRenderer instance = new ItemElectisPolyhedronRenderer();
    
    public ItemElectisPolyhedronRenderer() {
    }
