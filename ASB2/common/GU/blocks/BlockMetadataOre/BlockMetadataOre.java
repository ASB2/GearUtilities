...
public class BlockMetadataOre extends BlockBase {
    ...
    public int idDropped(int par1, Random par2Random, int par3) {
        ...
        switch(par1) {
            ...
            case 0: return ItemRegistry.ItemAirCrystalShard.itemID;
            case 1: return ItemRegistry.ItemEarthCrystalShard.itemID;
            case 2: return ItemRegistry.ItemFireCrystalShard.itemID;
            case 3: return ItemRegistry.ItemWaterCrystalShard.itemID;
            case 4: return ItemRegistry.ItemEnergyCrystalShard.itemID;
            default: return 0;
        }
    }
