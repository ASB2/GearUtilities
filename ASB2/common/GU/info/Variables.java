...
public class Variables {
    ...
    public static void updateVariables(Configuration config) {
        ...
        COUNT_JUST_TANK_AIR_BLOCKS = config.get("Misc", "Count Only Air Blocks in Tank Size Calculation", COUNT_JUST_TANK_AIR_BLOCKS, "Set to true to count only air blocks").getBoolean(COUNT_JUST_TANK_AIR_BLOCKS);
