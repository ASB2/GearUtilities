...
public class BlockRegistry {
    ...
    public static final BlockMetadata METADATA_ORE = new BlockMetadata(Material.rock) {
        ...
        public void postInit() {
            ...
            wrappers.put(0, new MetadataWrapper(new String[] { "BlockElectisStone" }).addDrop(new ItemStack(this, 4, 0)));
            wrappers.put(1, new MetadataWrapper(new String[] { "BlockGarnetOre" }).addDrop(new ItemStack(this, 4, 1)));
        }
    };
    
    static {
        
        customBlockMap.put(Reference.MOD_ID.concat("MetadataOre"), METADATA_ORE.setBlockName("MetadataOre"));
    }
